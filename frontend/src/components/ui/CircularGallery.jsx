  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          ...
          if (uMysteryMode > 0.5) {
            ...
            // Dark silhouette with a slight purple/blue tint
            color.rgb = vec3(luma * 0.15) + vec3(0.02, 0.02, 0.08);
          }
      ...
      uniforms: {
        ...
        uMysteryMode: { value: this.mysteryMode ? 1.0 : 0.0 }
      },
      transparent: true
    });
    const img = new Image();
...
class App {
  constructor(
    ...
    this.onResize();
    this.createGeometry();
    this.createMedias(items, bend, textColor, borderRadius, font, mysteryMode);
    this.update();
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font, mysteryMode) {
    const defaultItems = [
